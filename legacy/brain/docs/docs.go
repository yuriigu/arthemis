    ...
    "paths": {
        ...
        "/activity/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Activity retrtieved successfully",
                        "schema": {
                            "$ref": "#/definitions/models.Activity"
                        }
                    },
        ...
        "/indicator/create": {
            "post": {
                ...
                "responses": {
                    "202": {
                        "description": "IDs of created indicators",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "integer"
        ...
        "/indicator/delete/{id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "Indicator removed successfully",
                        "schema": {
                            "type": "boolean"
                        }
                    },
        ...
        "/indicator/update/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Indicator details to update",
                        "name": "project",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/indicator/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Indicator retrtieved successfully",
                        "schema": {
                            "$ref": "#/definitions/models.Activity"
                        }
                    },
        ...
        "/location/create": {
            "post": {
                ...
                "responses": {
                    "202": {
                        "description": "IDs of created locations",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "integer"
        ...
        "/location/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Location retrtieved successfully",
                        "schema": {
                            "$ref": "#/definitions/models.Location"
                        }
                    },
        ...
        "/observation/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "List of observation details",
                        "name": "observations",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "202": {
                        "description": "IDs of created observations",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "integer"
        ...
        "/observation/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Observation retrtieved successfully",
                        "schema": {
                            "$ref": "#/definitions/models.Activity"
                        }
                    },
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.ProponentInput"
                            }
                        }
                    }
                ],
